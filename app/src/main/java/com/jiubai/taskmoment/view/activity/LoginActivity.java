 ...
 * 登录页面
 */
public class LoginActivity extends Activity implements ILoginView, IGetVerifyCodeView, TextWatcher,
        ...
        switch (rippleView.getId()) {
            case R.id.rv_btn_getVerifyCode:
                if (!Config.IS_CONNECTED) {
                    Toast.makeText(LoginActivity.this, R.string.cant_access_network,
    ...
    public void onGetVerifyCodeResult(boolean result, String info) {
        if(result){
            ...
            Toast.makeText(LoginActivity.this, "获取失败，请重试", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class TimeCount extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    rv_btn_getVerifyCode.setOnRippleCompleteListener(LoginActivity.this);
                    ...
                    verifyBgShape.setColor(ContextCompat.getColor(LoginActivity.this, R.color.primary));
                }
            });
        }
        ...
        public void onTick(final long millisUntilFinished) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    final GradientDrawable verifyBgShape
                            = (GradientDrawable) btn_getVerifyCode.getBackground();
                    verifyBgShape.setColor(ContextCompat.getColor(LoginActivity.this, R.color.gray));
                }
            });
        }
    }
